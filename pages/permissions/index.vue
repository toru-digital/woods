	...
	<transition name="fade">
		<div class="w-full h-full grid place-items-center bg-white">
			<div v-if="!$store.state.permissions_has_gps">
				...
				/>
				<p class="w-full text-center text-2xl font-bold mb-8">Location is key!</p>
				...
				<div class="w-full grid place-items-center mt-32 gap-y-4">
					<button
						...
						:class='testing_has_gps ? "pointer-events-none opacity-25" : ""'
					...
					<button :class='!testing_has_gps ? "opacity-0" : ""'>Testing GPS...</button>
				</div>
			</div>
			<div
				v-if="
			...
			>
				<img
					...
					class="w-[75vw] mx-auto aspect-square mb-4"
				/>
				<p class="w-full text-center text-2xl font-bold mb-8">Which way?</p>
				<p class="text-center text-md mx-16">
				...
				<div class="w-full grid place-items-center mt-32 gap-y-4">
					<button
						class="bg-blaze-400 active:bg-blaze-200 active:scale-95 transition-all text-white rounded-full px-8 py-4 w-[50vw] max-w-[200px]"
						:class='testing_has_compass ? "pointer-events-none opacity-25" : ""'
					...
					<button  :class='!testing_has_compass ? "opacity-0" : ""'>Testing Compass...</button>
				</div>
			</div>
			<div
				v-if="
			...
			>
				<img
					...
					class="w-[75vw] mx-auto aspect-square mb-4"
				/>
				<p class="w-full text-center text-2xl font-bold mb-8">Time to fill up!</p>
				<p class="text-center text-md mx-16">
				...
				<div class="w-full grid place-items-center mt-32 gap-y-4">
					<button
						class="bg-blaze-400 active:bg-blaze-200 active:scale-95 transition-all text-white rounded-full px-8 py-4 w-[50vw] max-w-[200px]"
						:class='testing_has_fullscreen ? "pointer-events-none opacity-25" : ""'
					...
					<button  :class='!testing_has_fullscreen ? "opacity-0" : ""'>Testing Fullscreen...</button>
				</div>
			</div>
		</div>
	</transition>
